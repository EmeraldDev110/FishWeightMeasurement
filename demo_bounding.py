...
# Define directories
# base_dir = 'D:/mywork/fish_detect/MaskDataset/MaskDataset/mask11'
base_dir = 'C:/Users/Administrator/Downloads/Data package from August 13th/Fish6/Fish6'
output_dir = 'output'
...
if __name__ == "__main__":
    ...
    for i in range(len(images)):
        ...
        if filename.endswith('.png') or filename.endswith('.jpg'):
            ...
            # binary_image = cv2.resize(binary_image, (640, 480))
            # cv2.imshow(filename, binary_image)
            # while True:
                c = cv2.waitKey(1)
                if c == 27:
                    break
